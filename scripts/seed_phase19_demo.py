...
async def seed_resources(
    ...
    specs = [
        ...
        {
            'ext': 'ghe/repos/customer-portal',
            'app': ghe,
            'kind': 'repository',
            'resource_type': 'repository',
            'resource_key': 'ghe/repos/customer-portal',
            'description': 'Customer portal repository',
            'privilege': ResourcePrivilegeLevel.write,
            'env': ResourceEnvironment.production,
            'key': 'repo_gui',
        },
...
async def seed_access_artifacts(
    ...
    items = [
        ...
        },
        {
            ...
            'raw_name': 'write permission on customer-portal',
            'effect': 'allow',
            'observed_at': observed,
            'payload': {
                'login': 'alexei.voronov',
        ...
        # Contractor — limited GHE access
        {
            ...
            'raw_name': 'read permission on customer-portal',
            'effect': 'allow',
            'observed_at': observed,
            'payload': {
