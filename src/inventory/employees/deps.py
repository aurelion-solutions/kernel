...
def get_employee_service() -> EmployeeService:
    """Return EmployeeService with injected EventService; SubjectService shares the same event bus."""
    ...
    return EmployeeService(event_service=event_service, subject_service=subject_service)
