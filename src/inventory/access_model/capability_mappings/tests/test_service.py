...
from src.inventory.access_model.capability_mappings.exceptions import (
...
from src.inventory.access_model.capability_mappings.schemas import CapabilityMappingCreate
from src.inventory.access_model.capability_mappings.service import CapabilityMappingService
...
async def test_delete_mapping_with_dependent_capability_grants_raises_in_use_error(session_factory) -> None:
    ...
    from src.inventory.access_model.capability_mappings.exceptions import CapabilityMappingInUseError
