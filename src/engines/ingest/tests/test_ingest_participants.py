...
import pytest
from src.engines.ingest.schemas import ConnectorResultIngestRequest
from src.engines.ingest.service import ingest_connector_result
...
async def test_ingest_success_log_uses_ingest_capability_and_application_target(session_factory) -> None:
    ...
    assert ev.initiator_id == 'engines.ingest'
    assert ev.actor_id == 'engines.ingest'
