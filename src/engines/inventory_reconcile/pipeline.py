...
Design decisions:
  ...
  - NO events here — events are emitted by ``engines/inventory-reconciles/service.py`` only.
...
Known race (documented):
  ...
  (``engines/inventory-reconciles/service.py``).
...
from src.engines.inventory_reconcile.hashing import compute_natural_key_hash
...
from src.engines.inventory_reconcile.registry import get_handler
...
from src.engines.inventory_reconcile.views import AccessArtifactRowView, AccessFactRowView
...
# compute_natural_key_hash is imported from src.engines.inventory_reconcile.hashing.
...
async def run_reconciliation(
    ...
    *,
    ...
    (``engines/inventory-reconciles/service.py``).  Documented here; revisit if
