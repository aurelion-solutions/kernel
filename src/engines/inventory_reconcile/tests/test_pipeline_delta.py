...
from src.engines.inventory_reconcile.models import ReconciliationDeltaOperation, ReconciliationRunStatus
...
async def test_pipeline_delta_creates_run_and_items(
    ...
    async with session_factory() as session:
        from sqlalchemy import select
        from src.engines.inventory_reconcile.models import ReconciliationDeltaItem, ReconciliationRun
...
async def test_pipeline_delta_unchanged_count(
    ...
    from src.engines.inventory_reconcile.pipeline import _compute_natural_key_hash
