...
``src.engines.inventory_reconcile.models``, which validates model structure
at collection time.
"""
...
def _sync_drop_recon_schema(sync_conn: Any) -> None:
    ...
    # Drop child before parent (FK order) — Phase 15 migration creates reconciliation_* names
