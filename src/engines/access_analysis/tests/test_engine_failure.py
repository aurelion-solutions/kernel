...
from src.engines.access_analysis.tests.conftest import seed_pending_scan_run
from src.inventory.assessment.findings.models import Finding
from src.inventory.assessment.scan_runs.models import ScanRun, ScanRunStatus
...
async def test_engine_failure_sets_status_failed(session_factory, engine_test_lake_session) -> None:
    ...
    with patch(
        'src.engines.access_analysis.engine.load_sod_rules',
