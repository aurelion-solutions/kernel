...
from src.engines.access_analysis._engine_dedupe import FindingEmission, StatusChangeEmission
from src.engines.access_analysis.engine import EngineResult, ScanEngine
from src.inventory.assessment.scan_runs.models import ScanRun, ScanRunStatus, ScanRunTrigger
from src.inventory.assessment.scan_runs.repository import (
    get_scan_run_by_id,
    insert_scan_run,
)
...
_ACTOR_KIND = EventParticipantKind.COMPONENT
