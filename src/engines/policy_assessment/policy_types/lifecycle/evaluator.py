...
"""Lifecycle policy type — pure evaluators, IO-free, DB-free.

Rule/cartridge: terminated_subject_access — subjects in a terminal lifecycle
state (terminated, expired, banned, etc.) that still hold active access.

Deterministic: given the same inputs returns byte-identical output.
