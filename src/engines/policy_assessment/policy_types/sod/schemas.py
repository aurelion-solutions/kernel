...
class CapabilityGrantOverride(BaseModel):
    ...
    def _validate_scope_value_normalization(cls, v: str | None) -> str | None:
        ...
        if v != v.strip() or v != v.lower() or len(v) > 255:
            from src.engines.policy_assessment.policy_types.sod.exceptions import WhatIfScopeValueInvalidError
...
class SodViolationResponse(BaseModel):
    ...
    def from_violation(
        ...
        from src.engines.policy_assessment.policy_types.sod.evaluator import Violation
