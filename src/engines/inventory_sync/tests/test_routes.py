...
"""Route tests for POST /inventory-reconciles/runs/{id}/apply."""
...
from src.engines.inventory_sync.routes import router as sync_apply_router
...
async def test_apply_happy_path(session_factory) -> None:
    """POST /inventory-reconciles/runs/{id}/apply with mode=auto_apply → 200 with applied_count=2."""
    run_id = uuid4()
    ...
    async with AsyncClient(
        ...
        resp = await client.post(
            f'/inventory-reconciles/runs/{run_id}/apply',
