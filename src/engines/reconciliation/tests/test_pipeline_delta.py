...
from src.engines.reconciliation.models import ReconciliationDeltaOperation, ReconciliationRunStatus
from src.engines.reconciliation.pipeline import run_reconciliation
...
async def test_pipeline_delta_creates_run_and_items(
    ...
    async with session_factory() as session:
        from sqlalchemy import select
        from src.engines.reconciliation.models import ReconciliationDeltaItem, ReconciliationRun
...
async def test_pipeline_delta_unchanged_count(
    ...
    from src.engines.reconciliation.pipeline import _compute_natural_key_hash
