...
from src.capabilities.access_analysis.capabilities.deps import get_capability_service
from src.capabilities.access_analysis.capabilities.exceptions import (
    CapabilityNotFoundError,
    CapabilitySlugAlreadyExistsError,
)
from src.capabilities.access_analysis.capabilities.schemas import (
    CapabilityCreate,
    CapabilityPatch,
    CapabilityRead,
)
