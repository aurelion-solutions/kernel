...
from src.capabilities.access_analysis.mitigations.schemas import MitigationCreate, MitigationStatusPatch
...
async def test_activate_then_create_second_proposed_raises_duplicate(session_factory) -> None:
    ...
    async with session_factory() as session:
        ...
        from src.capabilities.access_analysis.mitigations.schemas import MitigationCreate
