...
``src.capabilities.reconciliation.models``, which validates model structure
at collection time.
"""
...
async def migration_engine() -> AsyncEngine:  # type: ignore[misc]
    ...
    from src.capabilities.reconciliation.models import (  # noqa: PLC0415
    ...
    tables_to_create = [t for t in Base.metadata.sorted_tables if t not in recon_tables]
