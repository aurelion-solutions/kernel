...
from src.capabilities.provisioning.create_account import create_account
from src.capabilities.provisioning.delete_account import delete_account
...
router = APIRouter(prefix='/applications', tags=['provisioning'])
