...
from src.capabilities.reconciliation.models import ReconciliationDeltaOperation
...
from src.capabilities.sync_apply.lake_writer import (
    DenormResolver,
    preflight_recover_already_written,
    write_run_batch,
)
from src.capabilities.sync_apply.models import (
    SyncApplyResult,
...
from src.capabilities.sync_apply.repository import (
    bulk_insert_results,
    create_apply_run,
...
_COMPONENT = 'capabilities.sync_apply'
...
class SyncApplyService:
    ...
    async def _load_items(
        ...
        if mode == SyncApplyRunMode.selected_items:
            ...
            # Validate all requested items are approved
        ...
        # auto_apply, manual_apply, dry_run — load all approved items
