...
from src.capabilities.lake_migration.deps import get_lake_migration_service
...
from src.capabilities.lake_migration.schemas import (
...
async def _run_migration_background(
    *,
    ...
    """
    from src.capabilities.lake_migration.service import LakeMigrationService  # noqa: PLC0415
    ...
    try:
        async with session_factory() as bg_session:  # type: ignore[operator]
            ...
            from src.capabilities.lake_migration.models import LakeMigrationRun as _Run  # noqa: PLC0415
